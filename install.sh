...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " Developers > AtaaXD ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e " Auther : ${green}Wasta Ganteng ${NC}"
echo -e " © Script By My Self AtaaXD ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/ataaxd666/install/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/ataaxd666/install/main/Register"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/ataaxd666/install/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
